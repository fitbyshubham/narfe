...
const AuthSwiper = () => {
  return <div className="slider">
      <Swiper modules={[Autoplay, Pagination]} loop slidesPerView={1} spaceBetween={0} autoplay={{
      delay: 5000
    }} breakpoints={{
      576: {
        slidesPerView: 1.2
    ...
    }} roundLengths pagination={{
      el: '.swiper-pagination',
      dynamicBullets: true
    }}>
        {authSwiperSlides.map((slide, idx) => <SwiperSlide key={idx}>
