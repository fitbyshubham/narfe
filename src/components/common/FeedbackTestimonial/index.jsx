...
import { feedbackTestimonials } from '../data';
import 'swiper/css';
...
const FeedbackSlide = ({
  ...
  return <Card className="mb-0 border rounded">
...
const FeedbackTestimonial = () => {
  return <section className="section pt-5 pb-7 py-sm-9 position-relative features-4">
      <Container>
        <Row className="testimonials-2" data-aos="fade-up" data-aos-duration={200}>
          ...
          <Col lg={8} className="offset-lg-1">
            <div className="slider">
              <Swiper loop modules={[Navigation, Autoplay]} spaceBetween={24} autoplay={{
              delay: 5000
            }} roundLengths slidesPerView={1} navigation={{
              nextEl: '.swiper-custom-next',
              prevEl: '.swiper-custom-prev'
            }}>
                {feedbackTestimonials.map((feedback, idx) => <SwiperSlide key={idx}>
