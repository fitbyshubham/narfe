...
const CustomToggle = ({
  ...
  return <div role="button" onClick={decoratedOnClick} className={clsx('text-dark', {
...
const FAQs = () => {
  return <section className="section py-6 pt-sm-6 position-relative">
          ...
          <Col md={10} lg={8}>
            <div id="faqContent">
              <Accordion defaultActiveKey={'0'} className="custom-accordionwitharrow" id="accordionExample">
                {FAQContent.map((faq, idx) => <Card className="mb-1 border rounded-sm" key={idx}>
